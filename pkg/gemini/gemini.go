...
4.  文字数: 解説の文字数は800文字以上を目安とし、内容を十分に伝えられるように記述してください。ただし、情報量が少ない場合は、可能な範囲で詳細に記述してください。
5.  1行あたりの文字: 1行はあたりの文字は80文字程度でおさまるようにして下さい。長くなる場合は改行して下さい。1行あたりの文字が長くなりすぎないようにして下さい。
